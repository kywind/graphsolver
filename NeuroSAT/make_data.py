...
if __name__ == "__main__":
    ...
    parser.add_argument('--n_pairs_train', action='store', dest='n_pairs_train', type=int, default=1)
    parser.add_argument('--n_pairs_valid', action='store', dest='n_pairs_valid', type=int, default=1)
    parser.add_argument('--min_n', action='store', dest='min_n', type=int, default=5)
    parser.add_argument('--max_n', action='store', dest='max_n', type=int, default=5)
    ...
    train_path = os.path.join(opts.out_dir, 'test.dimacs')
    valid_path = os.path.join(opts.out_dir, 'test.dimacs')
